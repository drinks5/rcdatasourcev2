...
val sparkVersion = Def.setting {
  CrossVersion.partialVersion(scalaVersion.value) match {
    ...
    case _ => Option(System.getenv("SPARK2_VERSION")).getOrElse("3.1.1")
  }
}
...
val sparkRedshiftVersion = Def.setting {
  CrossVersion.partialVersion(scalaVersion.value) match {
...
libraryDependencies ++= Seq(
  ...
  "org.apache.hbase" % "hbase-common" % "2.4.2",
  ...
  "za.co.absa" %% "abris" % "3.2.1" excludeAll(excludeAvro, excludeSpark),
